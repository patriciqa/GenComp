...
function setup() {
  ...
  purpleButton.position(50, 410);
  purpleButton.mousePressed(changetoPurple);

  purpleButton = createButton('Red');
  purpleButton.position(300, 410);
  purpleButton.mousePressed(changetoRed);
}
