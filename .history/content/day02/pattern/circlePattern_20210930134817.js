...
function setup() {
  ...
  purpleButton.mousePressed(changetoPurple('green')); 

  greenButton = createButton('Green');
  greenButton.position(100, 410);
  greenButton.mousePressed(changetoGreen('green')); 

  colorButton = createButton('Colorful');
  colorButton.position(250, 410);
  colorButton.mousePressed(changetoGreen('colorful'));
}
