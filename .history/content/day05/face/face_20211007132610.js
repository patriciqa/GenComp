...
let successful = new Array("(｡♥‿♥｡)", "(♥ω♥ ) ~♪", "(๑♡⌓♡๑)", "(°◡°♡).:｡", "(⋈◍＞◡＜◍)。✧♡", "♡＾▽＾♡", "(◍•ᴗ•◍)❤", "( ˘͈ ᵕ ˘͈♡)˚๐*˟ ♡", "°₊·ˈ∗♡( ˃̶᷇ ‧̫ ˂̶᷆ )♡∗ˈ‧₊°", "( ื▿ ืʃƪ)", "( ˘ ³˘)♥", "( *¯ ³¯*)♡", "⁽ ¨̮⁾⁽¨̮ ⁾*˚‧♡", "웃♥유", "(ෆ❛ัᵌ❛ัෆ)°");
let meh = new Array("(*•̀ᴗ•́*)و ̑̑", "(๑•̀ㅂ•́)و", "!(•̀ᴗ•́)و ̑̑", "(•̀o•́)ง", "ೕ(˃̵ᴗ˂̵ ๑)", "ೕ(•̀ᴗ•́)", "٩(•̤̀ᵕ•̤́๑)ᵒᵏᵎᵎᵎᵎ", "٩(｡•ω•｡)و", "٩(｡•ㅅ•｡)و", "(و ˃̵ᴗ˂̵)و", "¡¡¡( •̀ ᴗ •́ )و!!!", "＼＼\(۶•̀ᴗ•́)۶//／／", "(•̀ᴗ•́)൬༉", "٩(ര̀ᴗര́)", "ೕ(˃̵ᴗ˂̵ ๑)");
let love = new Array("¯\_(⊙_ʖ⊙)_/¯", "¯\_(☯෴☯)_/¯", "¯\_▒ – ﹏ – ▒_/¯", "˘\_( õ ‹3 ó)_/˘", "¯\_(⊙︿⊙)_/¯", "＼（〇_ｏ）／", "┐(￣ー￣)┌", "└(・-・)┘", "╚═[ ˵ •̀ ﹏ •́ ˵ ]═╝", "└║ ՞ ౪ ՞ ║┘", "└༼ •́ ͜ʖ •̀ ༽┘", "┗| ຶӫ ຶ|┛", "ヽ( ´¬`)ノ", "乁[ ◕ ᴥ ◕ ]ㄏ", "乁( ⁰͡ Ĺ̯ ⁰͡ ) ㄏ");
// let love = new Array("", "", "", "", "", "", "", "", "", "", "", "", "", "", "")
